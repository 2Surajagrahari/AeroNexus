...
const Loader = () => {
  ...
  return (
    <div
      className={`w-full min-h-screen flex items-center justify-center relative overflow-hidden transition-colors duration-300 ${isDark ? 'bg-gray-900' : 'bg-gray-100'}`}>
      <div
        className={`absolute inset-0 bg-grid ${isDark ? 'opacity-20' : 'opacity-10'}`}></div>
      <button
